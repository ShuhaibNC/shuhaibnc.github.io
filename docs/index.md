...
features:
  - title: Cybersecurity
    details: Learning, Foundations, Practice, Tools and Resources
    link: /cybersecurity
    icon: |
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5a6ed0ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield-ellipsis"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M8 12h.01"/><path d="M12 12h.01"/><path d="M16 12h.01"/><title>Ad-block / Privacy</title></svg>

  - title: Programming
    details: Programming Tools, Resources, 
    link: /coding
    icon: |
  ...
  - title: Science
    details: Science, Astronomy, Psychology
    link: /science
    icon: |
  ...
  # - title: Movies and TV 
  #   details: My Lists and Suggestions
  #   link: /movies
  #   icon: |
  #     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0
  #     0 24 24" fill="none" stroke="#7ae9f7ff" stroke-width="2"
  ...
  - title: BreachMon
    details: A Threat Intelligence Search Engine
    link: /BreachMon
    target: "_blank"
    icon: |
  ...
  - title: Mozhi Dictionary
    details: A Fast And Efficient Malayalam Dictionary
    link: /mozhi
    target: "_blank"
    icon: |
  ...
  - title: TestFiles
    ...
    target: "_blank"
    details:
      Some Files To Test Your Internet Speed
